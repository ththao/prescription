...
<br>
<?php
$this->load->view('prescription/prescription'); ?>
<br><br>
...
<script>
    function printPrescription() {
        window.open("/prescription/printPrescription/" + <?php echo $patient->id; ?>);
    }

    function printBill() {
        window.open("/prescription/bill/" + <?php echo $patient->id; ?>);
    }
</script>