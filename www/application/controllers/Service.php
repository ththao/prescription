...
class Service extends My_Controller
{
    ...
    {
        if (isset($_POST) && !empty($_POST['service_name']) && !empty($_POST['price'])) {
            $service = $this->service_model->findOne(array('service_name' => $_POST['service_name']));
            if (!$service) {
    ...
    {
        if (isset($_POST) && !empty($_POST['service_name']) && !empty($_POST['price'])) {
            $service = $this->service_model->findOne(array('id' => $id));
